...
func main() {
	...
	// Note that this isn’t always possible. For example, if you needed to call a generic function
	// that had no arguments, you would need to include the type arguments in the function call.
